...
for request_info in procedure_bd_info:
    ...
    # получаем данные об идентификаторе спецсчета
...
excel_list_with_account.write_data_from_iter(excel_data_with_account, top_line=['Процедура',
                                                                                'Id заявки',
...
excel_list_excel_data_no_account.write_data_from_iter(excel_data_no_account, top_line=['Процедура',
                                                                                       'Id заявки',
                                                                                       'Наименование организации',
                                                                                       'ИНН',
                                                                                       'КПП',
